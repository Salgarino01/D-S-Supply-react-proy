                ...
                <nav className='flex flex-col'>
                    ...
                    <div className='min-w-0 flex flex-col h-full min-h-0'>
                        <button onClick={()=>setOpen(!open)}>
                            <SideCategories titulo="Combustible" ruta="/category/combustible"/>
                        </button>
                        <hr className={`w-full ${darkMode ? "text-dark-gray-text" : "text-light-gray" }`}/>
                        <button onClick={()=>setOpen(!open)}>
                            <SideCategories titulo="Motor" ruta="/category/motor"/>
                        </button>
                        <hr className={`w-full ${darkMode ? "text-dark-gray-text" : "text-light-gray" }`}/>
                        <button onClick={()=>setOpen(!open)}>
                            <SideCategories titulo="Transmision" ruta="/category/transmision"/>
                        </button>
                        <button onClick={()=>setOpen(!open)}>
                            <SideCategories titulo="Otros" ruta="/category/Otros"/>
                        </button>
                        <hr className={`w-full ${darkMode ? "text-dark-gray-text" : "text-light-gray" }`}/>
                    </div>
                </nav>
